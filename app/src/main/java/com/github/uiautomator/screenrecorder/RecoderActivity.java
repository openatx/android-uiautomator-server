...
import com.github.uiautomator.view.NamedSpinner;
...
public class RecoderActivity extends Activity {
    ...
    private void bindViews() {
        ...
        mVideoCodec.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(NamedSpinner view, int position) {
                RecoderActivity.this.onVideoCodecSelected((String) view.getSelectedItem());
            }
        });
        mAudioCodec.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            @Override
            public void onItemSelected(NamedSpinner view, int position) {
                RecoderActivity.this.onAudioCodecSelected((String) view.getSelectedItem());
            }
        });
        mVieoResolution.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(NamedSpinner view, int position) {
                ...
                RecoderActivity.this.onResolutionChanged(position, (String) view.getSelectedItem());
            }
        });
        mVideoFramerate.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
                RecoderActivity.this.onFramerateChanged(position, (String) view.getSelectedItem());
            }
        });
        mVideoBitrate.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
                RecoderActivity.this.onBitrateChanged(position, (String) view.getSelectedItem());
            }
        });
        mOrientation.setOnItemSelectedListener(new NamedSpinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(NamedSpinner view, int position) {
                if (position == 0) return;
                RecoderActivity.this.onOrientationChanged(position, (String) view.getSelectedItem());
            }
        });
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        RecoderActivity.this.requestPermissions(permissions, REQUEST_PERMISSIONS);
                    }
                })
    ...
    private void resetSampleRateAdapter(MediaCodecInfo.CodecCapabilities capabilities) {
        ...
        if (old == null || !(old instanceof ArrayAdapter)) {
            ArrayAdapter adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, new ArrayList<Integer>());
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void resetAudioBitrateAdapter(MediaCodecInfo.CodecCapabilities capabilities) {
        ...
        if (old == null || !(old instanceof ArrayAdapter)) {
            ArrayAdapter<Integer> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, new ArrayList<Integer>());
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            adapter.addAll(rates);
