...
package com.github.uiautomator.view;
...
public class NamedSpinner extends LinearLayout {
    ...
    public NamedSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final CharSequence[] entries = a.getTextArray(R.styleable.NamedSpinner_entries);
        if (entries != null) {
        ...
        int textAppearance = a.getResourceId(R.styleable.NamedSpinner_textAppearance,
                android.R.style.TextAppearance_DeviceDefault_Medium);
        CharSequence title = a.getText(R.styleable.NamedSpinner_name);
